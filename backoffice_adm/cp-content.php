              ...
              <div class="col-lg-12">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered table-hover table-striped datatable">
                    ...
                    <tbody>
                      <?php  $sqlC =  $obj_con->showchild($cat); ?>
                      <?php
                      ...
                      <tr>
                        <td><?php echo $i++;?></td>
                        <td>
                          <a href="cp-content-edit.php<?=$para?>&pid=<?=$FC['id']?>">
                            <?=$input_language['name']?>
                          </a>
                          
                          
                          <? if($FC['hide']==1){?><span class="text-warning text-right">HIDE</span><? }?>
                        </td>
                        <td>
                          <? if($FC['picture1']){?>
                          <img src="<?php echo phpResize('upload/content/'.$FC['picture1'],'&w=60',true);?>" alt="" style="float:right">
                          <? }?>
                        </td>
                        <td>
                          <? if($FC['picture1_en']){?>
                          <img src="<?php echo phpResize('upload/content/'.$FC['picture1_en'],'&w=60',true);?>" alt="" style="float:right">
                          <? }?>
                        </td>
                        <?php if (in_array($_GET['cat'], $check_cat_calendar_arr_cat)) { ?>
                          <td><?php echo $FC['calendar_day']; ?></td>
                          <td><?php echo $FC['calendar_day_end']=='0000-00-00'?'':$FC['calendar_day_end']; ?></td>
                        <?php } ?>
                        <td>
                        ...
                        <td>
                          <a href="cp-content-add-edit.php<?=$para?>&pid=<?=$FC['id']?>" class="btn btn-xs btn-warning"><i class="fa fa-pencil"></i></a>
                          <?php /*
                          <? if($FC['hide']==1){?>
                          ...
                          <? }?>
                          */?>
                          <a href="<?=$para?>&act=del&fid=<?=$FC['id']?>" class="btn btn-xs btn-danger btn-del"><i class="fa fa-trash"></i></a>
                          <a href="cp-content-pic.php<?=$para?>&pid=<?=$FC['id']?>" class="btn btn-xs btn-success">Img</a>
                        </td>
                      </tr>
                      <? }
                      }else{ ?>
