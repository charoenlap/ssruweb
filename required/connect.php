<?php
	...
	$mdir = "https://www.fsoftpro.com/web_ssru/".$path;
	$mdir_api = "https://www.fsoftpro.com/web_ssru/api/";
	...
	$PRIVATEuser_home="fsoftpro_ssweb";
	$PRIVATEpassword_home="EKq9nU8Z1";
	$PRIVATEdb_home="fsoftpro_ssweb";
