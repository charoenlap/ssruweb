...
$PHPTHUMB_CONFIG['high_security_password']      = 'XynQR%qe!@{@Xu}80t[<';      // required if 'high_security_enabled' is true, and must be at complex (uppercase, lowercase, numbers, punctuation, etc -- punctuation is strongest, lowercase is weakest; see PasswordStrength() in phpthumb.functions.php). You can use a password generator like http://silisoftware.com/tools/password-random.php to generate a strong password
...
function phpThumbURL($ParameterString, $path_to_phpThumb='../required/phpThumb/phpThumb.php') {
